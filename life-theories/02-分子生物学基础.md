...
2. not italicized
   ...
   - ${\rm DnaA^-}$ the protein produced by the *dnaA* gene
   - ${\rm LeuA^-}$ the phenotype of a $leuA$ mutant
...
5. Phenotypes: a non-italic three-letter abbreviation corresponding to the gene symbol, initial letter uppercase. _e.g._ ${\rm Arg^-}$, ${\rm Arg^+}$。
