...
```brew
brew install integzz/chinese/julia-cn
```

## 2. VS Code 调用 Julia

Julia 团队，曾经力推基于 Atom 的 Juno IDE，但目前已表示弃坑，全面投奔 VS Code。

> 对于较大的环境，Jupyter 中启动 Julia 明显更快，因为 VS Code 中 需要 reindex 这个时间有时会特别久。
...
![Julia in VS Code](images/vscode/julia2.png)
...
![julia](images/jupyter/python.png)
