...
作为一款以 GUI 见长的大众操作系统，Windows 的包管理器长期被忽视。如今，随着 Windows 的迭代和编程技术的日益普及，Windows 也有了经过时间检验的包管理器：**WinGet** 和 **Scoop**。其中，**WinGet**整个社区发布的安装脚本有 3000 多个，而**Scoop**官方仓库发布的安装脚本有 2000 多个。
